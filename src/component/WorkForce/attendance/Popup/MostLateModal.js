    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-7xl max-h-[80vh] flex flex-col">
        <div className="flex justify-between items-center border-b border-gray-200 px-6 py-4">
          <h2 className="text-xl font-semibold text-gray-900">Most Late Employees {formatRange(timeFilter)}</h2>
        ...
        <div className="flex-1 overflow-auto p-6">
          {loading ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mt-2">Loading most late employees...</p>
            </div>
          ) : error ? (
            ...
            <div className="text-center py-8 text-gray-500">
              <p>No data found for most late employees.</p>
            </div>
          ) : (
        ...
        <div className="border-t border-gray-200 px-6 py-4">
          <div className="flex justify-between items-center">
            <span className="text-sm text-gray-500">
              Showing {filteredEmployees.length} of {employees.length} most late employees
