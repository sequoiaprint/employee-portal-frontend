...
// XOR decryption function (same as in news.js)
...
const AddNews = ({ onNewsAdded, onClose }) => {
...
const requestCounter = useRef(0);
  ...
  console.log('Submission attempt #', requestCounter.current);
    ...
    try {
      if (!currentProfile?.uid) {
        throw new Error('User profile not found - cannot create news update');
      }
      ...
      const newsData = {
        ...
        console.log('Making API call #', requestCounter.current, 'with data:', newsData);
      ...
      // Call callbacks
      if (onNewsAdded) onNewsAdded(createdNews);
      if (onClose) onClose();
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-t-xl">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-white">Add News</h2>
            <button
              type="button"
              onClick={onClose}
          ...
          <p className="text-blue-100 mt-2">Share the latest company updates and announcements</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Publishing as</p>
